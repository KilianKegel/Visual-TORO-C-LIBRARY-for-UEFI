...
extern __declspec(dllimport) long long wcstoll(const wchar_t* s, wchar_t** endptr, int base);
...
**/
static intmax_t wcstoimaxCDEABI(const wchar_t* strSource, wchar_t** endptr, int base)
{
