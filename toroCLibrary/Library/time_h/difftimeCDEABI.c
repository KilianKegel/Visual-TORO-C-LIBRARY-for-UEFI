...
**/
static double _difftime64CDEABI(time_t time1, time_t time0)
{
    return (double)(time1 - time0);
}

static double difftimeCDEABI(time_t time1, time_t time0)
{
    return _difftime64CDEABI(time1, time0);
}

MKCDEABI(_difftime64);
MKCDEABI(difftime);