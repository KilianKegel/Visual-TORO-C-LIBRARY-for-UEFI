...
**/
size_t mbsrtowcsCDEABI(wchar_t* wcstr, const char** mbstr, size_t count, mbstate_t* mbstate)
{
    wchar_t wc;
    ...
    do {
        ...
        if (NULL == wcstr)
        {
            initial_count = strlen(*mbstr);     // Microsoft desided to return remaining string length if NULL == destination, not my choice!!!
            break;
        }
