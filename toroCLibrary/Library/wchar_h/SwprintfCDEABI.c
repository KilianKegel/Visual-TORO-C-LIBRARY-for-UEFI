...
extern __declspec(dllimport) int vswprintf(wchar_t* pszDest, size_t dwCount, const wchar_t* pszFormat, va_list ap);
...
static int swprintfCDEABI(wchar_t* pszDest, size_t dwCount, const wchar_t* pszFormat, ...) {
    va_list ap;
    int nRet;
