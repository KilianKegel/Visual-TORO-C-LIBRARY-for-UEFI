...
extern __declspec(dllimport) int vswscanf(const wchar_t* pwcsBuffer, const wchar_t* pwcsFormat, va_list ap);
...
**/
static int swscanfCDEABI(const wchar_t* pwcsBuffer, const wchar_t* pwcsFormat, ...) {
    va_list ap;
    int nRet;
