...
#ifndef _APPLICATION_ENTRY_POINT_C_H_
#define _APPLICATION_ENTRY_POINT_C_H_
...
{
  ProcessLibraryDestructorList (_cdegImageHandle, _cdegST);

  _cdegBS->Exit (_cdegImageHandle, Status, 0, NULL);
}
...
#endif//_APPLICATION_ENTRY_POINT_C_H_
