...
#include "osifUefiShellEntryPointEDKW.c"
...
Returns
    Status
**/
EFI_STATUS EFIAPI _cdeCRT0UefiShellW/*for non-EDK build environment*/(IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE* SystemTable)
{
...
//
    return _MainEntryPointShellW(ImageHandle, SystemTable);
}
